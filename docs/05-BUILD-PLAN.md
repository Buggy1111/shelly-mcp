...
> **Progress (2026-06-09):** **M0–M5 + scenes + v1.1 automation complete; local path live-verified on real hardware; pushed to a private repo.** 47 tools + 2 resources + 3 prompts, 204 tests, ruff + `mypy --strict` clean, ~3.4K LOC.
