...
> **Status:** **M0–M5 + scenes + v1.1 automation tools complete; local (Gen1+Gen2) & cloud paths live-verified on real hardware (2026-06-09).** 47 tools + 2 resources + 3 prompts, 204 tests, ruff + `mypy --strict` clean. Pushed to a **private** GitHub repo; public publishing still pending — see `05-BUILD-PLAN.md`.
